...
// NOTE: the easiest solution is to create a variable that hosts the state of the game. So if we are still playing or not, so this is gonna be a state variable, which kind of tells us the condition of a system in this case the condition will be is the game playing or not.
...
btnRoll.addEventListener('click', function () {
  // NOTE: playing here is a Boolean variable. And so that's why we don't have to write any condition.
